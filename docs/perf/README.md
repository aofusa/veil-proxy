...
- 全プロトコル×全機能マトリクス拡張後の回帰確認（F-114）: [`perf_f114_coverage_regression.md`](perf_f114_coverage_regression.md)
- **HTTP/3 mmsg バッチング（F-115 第2段）+ B-43 修正で HTTP/3 2 倍化（最新）**: [`perf_f115_stage2_b43.md`](perf_f115_stage2_b43.md)

...
| F-97 | P1 | 進行中 | [features/F-97-http3-grpc-app-layer-coverage.md](features/F-97-http3-grpc-app-layer-coverage.md) | レポート §4: HTTP/3 アプリ層 4 + gRPC 高度 3 + container_security 5（Slowloris/QPACK 枯渇/Path Bypass/WASM Crash/Base64 DOS）。**CI は F-98** |

...
| F-94 | P1 | 進行中 | [features/F-94-http3-grpc-report-items-1-11.md](features/F-94-http3-grpc-report-items-1-11.md) | http3_grpc_test_coverage_report 項目1〜11（Alt-Svc・UDP fallback・gRPC FC/WASM・h3spec ハーネス・amplification/0-RTT/fragmented LPM/half-closed・fuzz）。**CI は F-95** |
| F-95 | P2 | 未着手 | [features/F-95-h3spec-ci-integration.md](features/F-95-h3spec-ci-integration.md) | h3spec の CI 組み込み（F-94 から分離。ハーネスは F-94、GHA 配線のみ本チケット） |

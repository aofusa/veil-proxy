...
| F-99 | P1 | 進行中 | [features/F-99-test-coverage-report-h3-grpc.md](features/F-99-test-coverage-report-h3-grpc.md) | test_coverage_report: gRPC over H3 E2E 7 件 + container_security H3 gRPC/gRPC-Web 攻撃 6 件。**CI は F-100** |

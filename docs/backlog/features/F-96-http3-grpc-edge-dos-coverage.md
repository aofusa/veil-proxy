...
- [x] レポート §5 の 15 項目が実装または明確に文書化（クライアント制約による近似含む）
...
完了（fix/test）。  
詳細: `docs/artifacts/f96_failed_tests_report.md`  
検証: 単体 717 / 統合 53 / E2E 455+1 フレーキー(B-17 並列) / F-96 新規 E2E 7 PASS /  
http3_probe+grpc_probe ok / feature ビルド 0 警告・0 エラー。新規 B-* なし。

...
// HugePagesInfo, check_huge_pages_availability, configure_huge_pages は
// crate::system モジュールに移動しました。

// Coarse Timer（coarse_now 等）は crate::logging モジュールに移動しました。


// Prometheusメトリクス、ActiveConnectionMetric、ConnectionGuard は
// crate::metrics モジュールに移動しました。

// CatchUnwindFuture, spawn_with_panic_catch は
// crate::system モジュールに移動しました。
...
// HTTP_UPSTREAM_HEALTH, キャッシュメトリクス、CacheSaveContext,
// encode_prometheus_metrics, record_request_metrics, build_metrics_response は
// crate::metrics モジュールに移動しました。

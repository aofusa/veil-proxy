...
aggregate_reports() {
    ...
    local -a phases=(
        ...
        "full_features_security:full_features_security_report.txt"
        "admin_security:admin_security_report.txt"
        "compression_cache:compression_cache_report.txt"
        "http3:http3_report.txt"
        "l4_flood:l4_flood_report.txt"
        "websocket:websocket_report.txt"
        "grpc:grpc_report.txt"
        "rate_limit:rate_limit_report.txt"
        "wasm_security:wasm_security_report.txt"
        "metrics_probe:metrics_probe_report.txt"
        "otel_probe:otel_probe_report.txt"
